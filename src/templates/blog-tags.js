...
BlogTags.propTypes = propTypes
BlogTags.defaultProps = defaultProps
export default BlogTags
export const query = graphql`
  query BlogTagsQuery ($tag: String){
    allMarkdownRemark(limit: 2000, sort: {fields: [frontmatter___created], order: DESC}, filter: {fileAbsolutePath: {glob: "**/content/blog/**/*.md"}, frontmatter: {tags: {in: [$tag]}}}) {
      totalCount
      edges {
        node {
          id
